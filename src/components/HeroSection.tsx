  ...
  return (
    <div className="relative">
      <Image
        ...
        width={24}
        height={48}
        className="absolute left-0 top-72 hidden md:block opacity-95 -z-10"
      />
      <Image
        ...
        width={24}
        height={48}
        className="absolute right-0 top-12 hidden md:block -z-10"
      />
      <Image
        ...
        width={Infinity}
        height={Infinity}
        className="absolute right-0 -top-36 hidden md:block opacity-70 z-0"
      />
      <section className="py-20 px-4 bg-primary z-10">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between z-50">
          <div className="max-w-xl">
            ...
            <p className="text-[#989898] text-xl text-justify mb-8 tracking-wide z-50">
              ...
              community good projects and products by incentivizing them with a
              stipend.
            </p>
          </div>
