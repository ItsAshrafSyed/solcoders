					...
					<div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
						<div className="max-w-xl">
							...
							<p className="text-[#989898] text-xl text-justify mb-8 tracking-wide">
								...
								open-source projects on Solana. SolCoders primarily focuses on
								bringing university students and developers together to
								contribute to community good tools and products by incentivizing
								them with a stipend.
							</p>
						</div>
